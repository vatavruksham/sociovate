...
const socialLinks = [
  { label: 'X', href: 'https://x.com/sociovate', Icon: XIcon },
  { label: 'LinkedIn', href: 'https://linkedin.com/company/sociovate', Icon: Linkedin },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mb-4 text-sm leading-relaxed text-ink-soft">
              AI-powered social media automation hub. Plan, publish, analyze, and engage
        ...
        <div className="mt-8 border-t border-surface-200 pt-8 text-center">
          <p className="text-sm text-ink-muted">
            Copyright © Sociovate 2026 All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
